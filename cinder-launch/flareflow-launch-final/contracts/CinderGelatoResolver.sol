...
/**
 * ╔══════════════════════════════════════════════════════╗
 * ║     CinderGelatoResolver — Automated Keeper            ║
 * ╚══════════════════════════════════════════════════════╝
 *
 * WHAT THIS REPLACES:
 * ────────────────────
...
contract CinderGelatoResolver {

    // ── Config ─────────────────────────────────────────────────────────
    ICinderVault public immutable vault;
    ICinderMining     public immutable mining;
