...
/**
 * ╔══════════════════════════════════════════════════════╗
 * ║           EmberSale — EMBER Public Token Sale          ║
 * ╚══════════════════════════════════════════════════════╝
 *
...
contract EmberSale {
     ...
     * Call after sending 150M EMBER here from the EmberToken constructor allocation.
     */
    ...
    function claim() external afterFinalize {
        ...
        require(claimable > 0, "Sale: nothing to claim yet");

        claimed[msg.sender] += claimable;
        flow.transfer(msg.sender, claimable);
