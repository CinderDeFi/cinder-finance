 ...
 * ALLOCATION:
 * ────────────
 * 450M (45%) → CinderMining     — depositor rewards, 4 years
 ...
 * 100M (10%) → Founder vest   — 2-year linear, on-chain in CinderFounderVest
 *
...
contract CinderToken {
    ...
    /**
     * @param mining          CinderMining rewards contract    (45%)
     * @param timelock        Governor timelock / treasury   (25%)
     * @param sale            CinderSale contract              (15%)
     * @param community       Airdrop distributor or EOA     (5%)
     * @param founderVest     CinderFounderVest contract       (10%)
     */
    constructor(
        address mining,
        address timelock,
